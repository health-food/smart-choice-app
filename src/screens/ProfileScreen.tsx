...
const data = [
    ...
    {
        id: 2,
        title: 'My dietary wants',
        list: [],
    },
    {
        id: 3,
        title: 'My dietary dislikes',
        list: [
            {
                id: 0,
                title: 'Lactose',
    ...
    return (
        <View>
            <ScrollView style={styles.view}>
                <Background>
                    <View style={{marginTop: 32, marginBottom: 32, marginLeft: 20, width: 130, }}>
                        <Image
                        ...
                        <Button color={'#fff'} compact mode={'text'}
                                ...
                                style={{marginTop: 6}}>My profile</Button>
                    </View>
                </Background>
                {
                    data.map(item => (
                        <Card key={item.id} style={styles.mainCard}>
                            <Card.Content style={styles.header}>
                                ...
                                <Card.Actions>
                                    <Button onPress={() => onEditPress(item.id)}>Edit</Button>
                                </Card.Actions>
                            </Card.Content>
